...
saturn = Sphere::Saturn.new
p saturn.name
p "Rise"
p saturn.rise_at( 0, date, lon, lat ).localtime
p "Transit"
p saturn.meridian_transit( date, lon ).localtime
p "Set"
p saturn.set_at( 0, date, lon, lat ).localtime
...
neptune = Sphere::Neptune.new
p neptune.name
p "Rise"
p neptune.rise_at( 0, date, lon, lat ).localtime
p "Transit"
p neptune.meridian_transit( date, lon ).localtime
p "Set"
p neptune.set_at( 0, date, lon, lat ).localtime

uranus = Sphere::Uranus.new
p uranus.name
p "Rise"
p uranus.rise_at( 0, date, lon, lat ).localtime
p "Transit"
p uranus.meridian_transit( date, lon ).localtime
p "Set"
p uranus.set_at( 0, date, lon, lat ).localtime
